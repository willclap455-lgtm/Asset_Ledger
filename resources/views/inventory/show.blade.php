...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="btn-group"><a class="btn btn-outline-secondary btn-sm" href="{{ route('inventory-items.index') }}">Inventory</a><a class="btn btn-primary btn-sm" href="{{ route('inventory-items.edit', $item) }}">Edit</a><a class="btn btn-outline-primary btn-sm" href="{{ route('movements.create', ['item_ids[]' => $item->id]) }}">Move</a>@can('delete', $item)<form method="POST" action="{{ route('inventory-items.destroy', $item) }}" onsubmit="return confirm('Delete this inventory item?')">@csrf @method('DELETE')<button class="btn btn-outline-danger btn-sm">Delete</button></form>@endcan</div>
</div>
<div class="row g-3">
    <div class="col-xl-8">
